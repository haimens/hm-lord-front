        ...
        <div className={'container-fluid'}>
          <section className="row p-3 border-bottom">
            ...
            <div className="col-md-12 col-sm-12 d-flex flex-column flex-sm-row justify-content-between  ">
              ...
              <div>
                <Button label="当月" className={this.state.activeOptionTab === 0 ? 'hm-bg-green text-white' : 'mr-button-purple mr-purple-text'} onClick={() => this.monthSwitch(0)} />
                <Button label="前30天" className={this.state.activeOptionTab === 1 ? 'hm-bg-green text-white' : 'mr-button-purple mr-purple-text'} onClick={() => this.monthSwitch(1)} />
              </div>
            </div>
          </section>
        </div>
